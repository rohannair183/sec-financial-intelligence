  ...
  create or replace view `sec-edgar-intelligence`.`sec_dbt_dev`.`stg_income_statement_annual`
  OPTIONS()
  as -- Concepts: Revenues, COGS, GrossProfit, OperatingIncome, R&D, SG&A, D&A,
...
with latest_fetch as (
    ...
    from `sec-edgar-intelligence`.`raw`.`raw_income_statement_annual`
