  ...
  create or replace view `sec-edgar-intelligence`.`sec_dbt_dev`.`stg_balance_sheet`
  OPTIONS()
  as -- Concepts: Assets, Liabilities, StockholdersEquity, Cash, LongTermDebt,
...
with latest_fetch as (
    ...
    from `sec-edgar-intelligence`.`raw`.`raw_balance_sheet_snapshots`
