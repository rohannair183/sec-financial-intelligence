  ...
  create or replace view `sec-edgar-intelligence`.`sec_dbt_dev`.`stg_cash_flow_annual`
  OPTIONS()
  as -- Concepts: OperatingCF, InvestingCF, FinancingCF, CapEx, Buybacks, Dividends, D&A — annual.
...
with latest_fetch as (
    ...
    from `sec-edgar-intelligence`.`raw`.`raw_cash_flow_annual`
